...
pub fn render_pie_chart(canvas_id: &str, table_json: JsValue) -> Result<(), JsValue> {
    ...
    //let config = &pie::PieConfig{ label_column: 0, value_column: 1, cx: 400.0, cy: 400.0, outer_r: 200.0, inner_r: 160.0, default_font_size: 24.0, default_font: "24px sans-serif", middle_font_size: 108.0, middle_font: "108px sans-serif", text_color: "black", hover_title_color: "blue" };
